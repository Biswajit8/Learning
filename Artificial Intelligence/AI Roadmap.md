...
2. Understand how AI things work, Prompting, RAG
- Explore models: https://huggingface.co/
- Playground: OpenAI, Google Studio

3. Diffusion model
- https://stability.ai/

4. Build products using AI

5. Learn to build AI agents using n8n.io, Make.com, Lindi, Zapier, etc to solve problems
